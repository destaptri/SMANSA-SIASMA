    ...
    <div class="wrapper d-flex">
        ...
        <nav class="sidebar flex-column bg-white position-sticky">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link mt-2.5 {{ Route::currentRouteName() === 'kepsek.menu' ? 'active' : '' }}" href="{{ route('kepsek.menu') }}">
                        <i class="bi bi-grid"></i> MENU
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() === 'kepsek.laporan' ? 'active' : '' }}" href="{{ route('kepsek.laporan') }}">
            ...
            <div class="user-session ms-auto flex-row">
                <div class="dropdown">
                    <button
                        ...
                        <i class="bi bi-person-circle" style="font-size: 24px; position: absolute; top: 50%; left: 10%; transform: translate(-40%, -50%);"></i> Kepala Sekolah
                    </button>
